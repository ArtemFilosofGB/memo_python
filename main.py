...
def main():
    ...
    parser.add_argument('--command', choices=['add', 'edit', 'delete', 'read', 'filter', 'exit'], help='Enter command (add, edit, delete, read, filter, exit)')
    ...
    if args.command == 'add':
        ...
        for note in filtered_notes:
            print(note)
    elif args.command == 'exit' or args.command == 'quit':
